...
<ul>
    ...
    <li>
        Résultat de l'exercice 1 : <strong><?php  ?></strong>
    </li>
    <li>
        Résultat de l'exercice 2 : (utilisez la valeur 3 en paramètre dans cette exemple): <strong><?php  ?></strong>
    </li>
    <li>
        Résultat de l'exercice 3 :(utilisez les arguments Hello world) <strong><?php  ?></strong>
    </li>
    <li>
